...
Then, a simple classification of agents is also presented.
I'll then continue on analysing what makes an agent social.
...
In the next subsection I present a classification of agents into four different kinds, and in the following subsection we'll return to the topic of social ability in agents. 
