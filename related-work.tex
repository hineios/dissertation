...
What are they? How are they defined? how are they doing it? What about in games?
Present different techniques and models and rule out those that don't meet our needs

\subsection{Communication}
What level of communication is needed to achieve a social agent?
(should I approach this in it's own section? or should it be integrated in the previous one?)

\subsection{Playing the Game}
How do we make the agent a good player? 
It should be clear that we need a good playing agent based on the Social Agent part (a bad playing agent will get boring and players will lose interest in it)

\subsection{Modding}
Talk about mods and modding in general

\subsection{A Survival Game: Don't Starve Together}
...
\gls{dst} counts with over 4.6 million owners on Steam and has a daily peak of concurrent players of well over 5 thousand, reaching as high as 9 thousand concurrent players.
...
Over twenty-five hundred mods are available for the game on the Steam Workshop, making \gls{dst} a well-suited option to implement and test our solution.
